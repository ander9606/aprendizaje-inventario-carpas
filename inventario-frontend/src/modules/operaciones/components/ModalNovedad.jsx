...
export default function ModalNovedad({ ordenId, productos = [], onClose }) {
    ...
    return (
        <div className="fixed inset-0 bg-black/50 z-50 flex items-end sm:items-center justify-center">
            <div className="bg-white w-full sm:max-w-lg sm:rounded-xl rounded-t-xl max-h-[95vh] flex flex-col">
                {/* Header */}
                <div className="p-4 border-b border-slate-200 flex items-center justify-between shrink-0">
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            <h3 className="text-lg font-semibold text-slate-900">Reportar Novedad</h3>
                            <p className="text-xs text-slate-500">Se notificará a administración</p>
                        </div>
                    </div>
